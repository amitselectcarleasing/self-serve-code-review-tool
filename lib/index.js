...
class CodeReviewTool {
  ...
  calculateScore(findings) {
    ...
    const weights = {
      ...
      typescript: 15,
      security: 25,
      'test-cases': 20,  // Updated: Test cases now worth 20 points out of 100 (80/20 split)
      complexity: 10,
      dependencies: 10,
      performance: 10,
      architecture: 10,
  ...
  calculateWeightedTestScore(findings) {
    ...
    if (findings.weightedCoverage && findings.weightedCoverage.weightedScore !== undefined) {
      ...
      console.log(`   Total Test Points: ${(findings.weightedCoverage.breakdown.coreLogic.points + findings.weightedCoverage.breakdown.infrastructure.points).toFixed(1)}/20`);
